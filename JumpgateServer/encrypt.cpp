...
char * getFileAndDecrypt (char* file)
{
	...
	str = (char *) decrypt_string ("pokd(3ldk394010193kkJJ*+2TDKJ3ie", fileData);
	pfree ((void **)&fileData);
	return (str);
}
...
main()
{
	...
	strcpy(buffer1, "TESTKEY");
	//strcpy(buffer2, "the master blaster man");
	strcpy(buffer2, "QgmlW1HCwj31JB1dK/amX3R.jqVHN/Gp06b0");
	printf ("TESTING BLOWFISH\n");
	printf ("KEY: %s\n\n", buffer1);
	printf ("DATA: %s\n", buffer2);
	//buffer = encrypt_string(buffer1, buffer2);
	buffer = decrypt_string(buffer1, buffer2);
